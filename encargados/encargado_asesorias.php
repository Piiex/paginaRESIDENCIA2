...
if ($encargado !== 'encargado_asesorias') {
...
$stmt = $conn->prepare("
    SELECT 
        ad.id, ad.file_name, ad.file_type, ad.uploaded_at, ad.comment, ad.usuario_id, 
        u.nombre AS docente_nombre,
        COUNT(ad.id) OVER() AS total_count
    FROM asesorias_documentos ad
...
<head>
    <meta charset="UTF-8">
    <title>Documentos de Asesorías</title>
    <link href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.1.3/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
<div class="container">
    <h1 class="my-4">Documentos de Asesorías</h1>
