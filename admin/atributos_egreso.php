...
<?php
// Obtener los docentes con documentos subidos en atributos de egreso
$sql = "SELECT u.id as user_id, u.nombre, d.file_name, d.file_type, d.comment, d.uploaded_at 
        FROM usuarios u
        JOIN atributos_egreso_documentos d ON u.id = d.user_id
...
<head>
    ...
    <title>Atributos de Egreso - Documentos Subidos</title>
...
<body>
    <div class="container mt-5">
        <h1 class="mb-4">Atributos de Egreso - Documentos Subidos</h1>
