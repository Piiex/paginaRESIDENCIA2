...
<?php
// Obtener los docentes con documentos subidos en investigacion_documentos
$sql = "SELECT u.id as user_id, u.nombre, d.file_name, d.file_type, d.comment, d.uploaded_at 
        FROM usuarios u
        JOIN investigacion_documentos d ON u.id = d.user_id
...
<head>
    ...
    <title>Investigación - Documentos Subidos</title>
...
<body>
    <div class="container mt-5">
        <h1 class="mb-4">Investigación - Documentos Subidos</h1>
