...
// Obtener la lista de alumnos de tipo "dual"
$query = "SELECT id, nombre FROM alumnos WHERE tipo_alumno = 'dual'";
...
if (isset($_GET['alumno_id'])) {
    ...
    $query = "SELECT id, file_name, file_type, comment FROM educacion_dual_documentos WHERE alumno_id = ?";
    $stmt = $conn->prepare($query);
...
<head>
    ...
    <title>Administración - Gestión de Educación Dual</title>
...
<body>
    ...
    <div class="container main-content">
        <h1 class="mb-4">Gestión de Alumnos Dual</h1>

        <div class="row">
            <div class="col-md-6">
                <div class="card file-list">
                    <div class="card-header bg-primary text-white">
                        <h5 class="card-title mb-0"><i class="fas fa-users"></i> Alumnos Duales</h5>
                    </div>
                    <div class="card-body">
                        <ul class="list-group">
